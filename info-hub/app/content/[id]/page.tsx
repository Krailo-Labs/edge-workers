        ...
        <div className="flex-1 overflow-y-auto p-5">
          ...
          {activeTab === 'ai' && (
            <div className="space-y-4 animate-in fade-in">
              ...
              {aiCustomResponse && (
                <div className="bg-white border border-stone-200 rounded-2xl p-4 shadow-2xs relative">
                  ...
                  <h5 className="text-[11px] font-bold text-stone-400 uppercase tracking-wider mb-2">Відповідь AI</h5>
